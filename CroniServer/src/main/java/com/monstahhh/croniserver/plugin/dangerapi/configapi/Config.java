...
class ItemManager {
    ...
    public static ItemStack getSkull(SkullType type) {
        ItemStack item = new ItemStack(Material.LEGACY_SKULL_ITEM, 1, (short) type.ordinal());
        return item;
    }
...
//	}
    ...
    public static ItemStack stripLore(ItemStack item) {
        if (item.getType().equals(Material.LEGACY_SKULL) || item.getType().equals(Material.LEGACY_SKULL_ITEM)) {
